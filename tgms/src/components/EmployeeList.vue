            ...
            <div class="card-body text-center">
              <div class="p-4 border radius-15">
                ...
                <!-- <p v-if="index==1">
					...
					<p v-if="index==3">
					<img src="https://bootdey.com/img/Content/avatar/avatar4.png"  width="110" height="110" class="rounded-circle shadow" alt="">
					</p>


					<p v-if="index==4">
					<img src="https://bootdey.com/img/Content/avatar/avatar5.png"  width="110" height="110" class="rounded-circle shadow" alt="">
					</p>
					...
					<p v-if="index==7">
					<img src="https://bootdey.com/img/Content/avatar/avatar8.png"  width="110" height="110" class="rounded-circle shadow" alt="">
					</p>

					<p v-if="index==8">
					<img src="https://bootdey.com/img/Content/avatar/avatar9.png"  width="110" height="110" class="rounded-circle shadow" alt="">
					</p> -->
