<template>
    <div> 
        ...
        <h1> Employee list</h1> <br>  <button > <router-link to="/" class="nav-link"> Add Employee </router-link> </button>
		...
		<div class="card radius-15">
			<div class="card-body text-center">
				<div class="p-4 border radius-15">
					...
					<router-link :to="{ name: 'Profile', params: {inf} }"> Visit Profile</router-link>
